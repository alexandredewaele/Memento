      ...
      <div className="hidden lg:flex flex-1 flex-col items-center justify-center bg-gradient-to-br from-primary to-blue-700 p-16 relative overflow-hidden">
        ...
        <div className="relative z-10 text-center text-white max-w-sm">
          ...
          <p className="text-blue-100 text-lg leading-relaxed">
            Your daily learning journal. Capture facts, words, insights, and
            quotes — one entry at a time.
          </p>
          <div className="mt-12 grid grid-cols-2 gap-4 text-left">
            {[
              ...
              },
              {
                icon: 'visibility',
                label: 'Insights',
                desc: 'Capture clarity',
              },
              {
                icon: 'format_quote',
                label: 'Quotes',
                desc: 'Inspiring words',
              },
            ].map((item) => (
              <div
                key={item.label}
                className="flex items-start gap-3 bg-white/10 rounded-xl p-3 backdrop-blur-sm border border-white/20"
              >
                <span className="material-icons-round text-blue-200 text-xl">
                  {item.icon}
                </span>
                <div>
